PROC PRINTTO LOG="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\PGM1.LOG" NEW
			PRINT="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\PGM1.LST" NEW;

** PROGRAM COMBINES GRAIL AND HEL DATA;

OPTIONS NOCENTER MPRINT COMPRESS = YES;
%LET PRODUCT=JANTOT; RUN;
%LET PRODLABEL=JANTOT; RUN;  /* VALUE IS SAME AS PRODUCT FOR ALL BRANDS EXCEPT ASMANEX */
                                    /* ASMANEX IS ASMANEX-DULERA OR ASMANEX-SING */ 

/*
*LIBNAME MMF "\\WPUSHH01\DINFOPLN\Marketing Mix PI\MMF 2012\MMF\&PRODLABEL"; 
\\wpushh01\dinfopln\Marketing Mix PI\MMF 2013\MMF\mfatnd_dec11nov12.sas7bdat
...
/* ----
Additional notes: At the time of running this program, the overall program attendance 
  by product, IMSID and month that is collected for 24 past months is missing.
  That is, dataset att.ATT.PGMCNTS_&COVDSN is missing. It has variables named PGMCNT1 - PGMCNT24 
  by PRODUCT, IMSID and MONTH. 
  Basically, this captures previous attendance or multiple attendance by a doc to use as covariate
  in the model. 
  Remedy: Use SFP1 - SFT24 from GRAIL as proxy (this is how it was done some years back).; 
---- */
...
*** SET MACRO VARS ***;
**********************;
%LET GRAILDAT=&PRODUCT._GRAIL1301; 
%LET ATTENDAT=MFATND_DEC11NOV12;
%LET SPKRDAT=MFSPKR_DEC11NOV12;
%LET COVDSN=FEB11JAN13;
%LET TARGDSN=TARGETS_2012;
...
%LET YRARRAY =(2011, 2012, 2012, 2012, 2012, 2012, 2012, 2012, 2012, 2012, 2012, 2012);

%LET NUMARRAY=(14, 13, 12, 11, 10, 9, 8, 7, 6, 5, 4, 3);    **GRAIL MONTHS;
%LET QTRARRAY=('2011Q4' '2012Q1' '2012Q1' '2012Q1' '2012Q2' '2012Q2' 
               '2012Q2' '2012Q3' '2012Q3' '2012Q3' '2012Q4' '2012Q4' );
...
/* -- commented as the historic monthly attendace data is missing currently. Instead use SFP from GRAIL
...
MERGE MMF.HEL_SUBSET(IN=A) 
      ...
      GRAIL.&GRAILDAT. (IN=B RENAME=(CAT=RATING SPEC=OSPEC) DROP=HODET: HOMFP: OFDET: OFMFP: OTDET: OTMFP: SPDET: SPMFP:)
      TARGETS(IN=T)
      /*-- PGMCNT  --*/
...
ARRAY SFP(24) SFP1-SFP24;  /* THESE ARE SFP DETAILS FRON GRAIL (not actual attendace as data is missing currently) */
DO I=1 TO 24;
