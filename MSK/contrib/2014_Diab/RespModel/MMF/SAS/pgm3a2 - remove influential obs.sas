PROC PRINTTO LOG="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\PGM3a2.LOG" NEW
             PRINT="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\PGM3a2.LST" NEW;
...
*************************************************;
%LET PROD=JANTOT;
%let title_prod=JANTOT;   /* USE PRODUCTS ACTUAL NAME RATHER THAN GRAIL NAME */
%let title_no=2; RUN;
...
%LET PATH=Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data; 
RUN;
