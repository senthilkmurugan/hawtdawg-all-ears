PROC PRINTTO LOG="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\pgm3b1 - run model all.LOG" NEW
			PRINT="Y:\Marketing Mix PI\InvOpt\P2 2014 AB\Promo\Diabetes Deep Dive\RespModel\MMF\Data\pgm3b1 - run model all.LST" NEW;
