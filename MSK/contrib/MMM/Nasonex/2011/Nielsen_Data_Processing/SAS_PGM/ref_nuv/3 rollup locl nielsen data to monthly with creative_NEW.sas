PROC PRINTTO LOG="\\wpushh01\dinfopln\PRA\DTC\NuvaRing\2011 profit plan\SAS Logs and Lists\3 rollup locl nielsen data to monthly with creative.LOG" NEW
			PRINT="\\wpushh01\dinfopln\PRA\DTC\NuvaRing\2011 profit plan\SAS Logs and Lists\3 rollup locl nielsen data to monthly with creative.LST" NEW;
***************************************************************************;
* ROLLUP WEEKLY BRAND-CREATIVE-DAYPART-MARKET DATA TO MONTHLY FOR DATA     ;
* DESCRIPTION/GRAPHING AND MODELING DATA PREP...                           ;
***************************************************************************;
TITLE "NMR DATA ROLLUP TO DMA-MONTHLY - JAN 2010 THROUGH JUN 2009";
OPTIONS PAGESIZE=MAX;

* LIBRARY STATEMENTS FOR INPUT DATASETS;
LIBNAME TEMP "\\WPUSHH01\DINFOPLN\PRA\DTC\NuvaRing\2011 profit plan\SAS Datasets"; 
...
DATA WITHDUPS; SET TEMP.LOCL_TV_MM_jan10_jun10;
	EQIVWGT=DURATION/60;
...
DATA TEMP.DMAS; SET TEMP.LOCL_TV_MM_jan10_jun10 (KEEP=MARKET); BY MARKET; IF FIRST.MARKET; RUN;
